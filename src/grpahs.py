...
def graphPopulation():
    ...
    axes[0].set_title("Number of Workers vs Retirees")  
    ...
    axes[1].set_title("Worker-to-Retiree Ratio")
...
def graphCpi():
    ...
    axes[1].set_ylabel("Purchasing Power")


    tick_indices = np.linspace(0, len(cpi.index) - 1, 7, dtype=int) 
