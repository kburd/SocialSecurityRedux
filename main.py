...
fund_model["real"] = 162_968_000_000.00 #Social Secuirty Fund Size in 1990
...
axes[1][0].plot(fund_model.index, fund_model["fund_ratio"], label="Fund Ratio")
axes[1][1].plot(fund_model.index, fund_model["real_fund_ratio"], label="Fund Ratio")
axes[1][1].plot(fund_model.index, fund_model["target_fund_ratio"], label="Fund Ratio")
